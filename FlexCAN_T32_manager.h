#ifndef FlexCAN_T32_manager_h
#define FlexCAN_T32_manager_h
#include <map>
#include <vector>
...
protected:
  ...
  void operator=(const FlexCAN_T32_manager &obj) {}
  FlexCAN_T32_manager(const FlexCAN_T32_manager &obj) {}
